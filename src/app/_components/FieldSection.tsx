...
export default function FieldSection() {
  return (
    <section id='fields' className='p-4 my-8 scroll-mt-20'>
      <h1 className='mb-8 text-2xl font-semibold text-center md:text-4xl'>
        Daftar Lapangan
      </h1>
        ...
        {fields.map((field) => (
          ...
          >
            ...
            <div className='flex flex-col gap-2 p-4 md:flex-row md:items-end'>
              ...
              <Link
                href='/dashboard/player/booking'
                aria-label='link booking'
                className='w-full border'
              >
                <Button color='primary' className="w-full">Booking Sekarang</Button>
              </Link>
            </div>
          </div>
        ))}
